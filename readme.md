...
* Študent mora **forkati uradni Git repozitorij predmeta** v svoj GitHub/GitLab račun.
* Vse vaje in projektno dokumentacijo oddaja **izključno znotraj lastnega forka**.
